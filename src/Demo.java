    ...
    public static void main(String[] args) throws Exception {
        ...
        while (frame.isVisible() && (grabbedImage = converter.convert(grabber.grab())) != null) {
            ...
            for (long i = 0; i < total; i++) {
                ...
                Point reference = new Point(x + w/2, y + h/2);
                Point offset = new Point(frame.getLocation().x, frame.getLocation().y);
                myRobot.mouseMove(reference.x() + offset.x(), reference.y() + offset.y());
